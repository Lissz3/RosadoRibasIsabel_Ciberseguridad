...
Un usuario es un alias o seudónimo utilizado para identificarse en un sistema
Debe ir acompañado de una contraseña
La unión usuario+contraseña corresponde a las credenciales de acceso --> aporta seguridad
...
Se deben cambiar las contraseñas cada 30-90 días tiempo sin repetir contraseñas que hemos puesto anteriormente
...
Peligros:
Acceso por varias personas
La información puede extraerse sin ser consciente
Robo de información
Entrada de información maliciosa
Corrupción de información importante

Recomendaciones:
Compartir carpetas únicamente cuando sea estrictamente necesario
Proteger las carpetas mediante permisos de acceso
...
No confiar por tener un navegador seguro instalado
concienciarnos y aprender a navegar de forma segura
Inlcuir protección con herramientas de seguridad

Actualizaciones en navegadores:
Necesitan ser actualziados
Es una aplicación más que va sufriendo cambios

Extensiones en navegadores:
Son pequeños programas instalados en el navegador
Hay que tener precaución con lo que se instala, dado que algunas pueden buscar un funcionamiento que no se indica
No es recomendable tener un gran número de ellas, ya que puede perjudicarel funcionamiento del navegador
Se pueden instalar verificando que no es maliciosa

URLS o direcciones de internet:
Una URL es el nombre a través del que nos conectamos a una página.
...
Nunca estar 100% seguros de una dirección
Verificar que la dirección está escrita correctamente
Antes de pulsar un enlace, verificar donde redirige
Verificar que el protocolo es https

Una url insegura suelen ser direcciones no reconocibles
no corresponden a un nombre de empresa
contiene caracteres alfanumericos
el protocolo no es https, si no http
...
Codigos QR
Evolución de código de barras que almacena información
Pueden contener enlaces maliciosos
Conexiones que no conocemos
Hay que verificar los enlaces detrás de los códigos QR con herramientas como QR Scanner

Certificados
Permite la identificación del remitente y ayuda a verificar al propietario de la web
Se puede comprobar en los candados de los navegadores web (a la izquierda de la url)
...
Precauciones
Remitentes desconocidos. Es mejor no abrir los emails de remitentes desconocidos dado que podemos darle información sobre que nuestra cuenta está activa.
En el envío de información confidencial
Spam
...
Tipos de pishing:
Correo electrónico
Vishing (Pishing a través de voz)
Smishing (Pishing a través de sms)
Carta nigeriana (Recibir premios, defunción de familiares lejanos, etc.)

Documentos adjuntos en el correo:
Ficheros que vienen enlzados a un mensaje
Pueden ser de distintos formatos (documentos de texto, hojas de cálculo, imágenes...)
No hay una respuesta 100% acertada acerca de su seguridad.

Peligros:
Pueden contener información maliciosa
Robo de información
Provocar la descarga de software adicional

Recomendaciones:
Por defecto no descargar ni abrir documentos adjuntos
Verificar que el remitente es correcto y el documento es seguro
Si sospechamos, aún pareciendo un remitente correcto, puede existir suplantación de identidad
